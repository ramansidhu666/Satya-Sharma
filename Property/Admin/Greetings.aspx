                    ...
                    <div class="form-horizontal row-fluid">
                         <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <asp:ImageButton Style="margin-bottom: 66px; margin-left: 165px;" ImageUrl="../PostCardImages/negative.png" OnClick="btnfavdelete_Click" ID="btnfavdelete" Text="Remove" runat="server" />
                            </div>
                        </div>
                          <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <asp:ImageButton Style="margin-bottom: 66px; margin-left: 165px;" ImageUrl="../PostCardImages/negative.png" OnClick="btnfavdelete_Click" ID="ImageButton1" Text="Remove" runat="server" />
                            </div>
                        </div>
                        <div class="control-group">
