        ...
        <section class="boxmenu">
                            <div class="box">
                                <a href="../Admin/SiteSettings.aspx">
                                    <img " src="../PostCardImages/Settings-icon.png"
                                        ></a>
                            </div>
     ...
     <%--   <section class="boxmenu">
                            <div class="box">
                                <a href="../Admin/ListOfPages.aspx">
                                    <img src="../PostCardImages/file_manager.png"
                                        ></a>
                            </div>
        ...
        <section class="boxmenu">
                            <div class="box">
                                <a href="../Admin/ListOfBlogs.aspx">
                                    <img  src="../PostCardImages/add_blog.png"
                                        ></a>
                            </div>
        ...
        <section class="boxmenu">
                            <div class="box">
                                <a href="../Admin/RegisteredUsers.aspx">
                                    <img  src="../PostCardImages/user-icon.png"
                                        ></a>
                            </div>
        ...
        <section class="boxmenu">
                            <div class="box">
                                <a href="../Admin/Appointments.aspx">
                                    <img  src="../PostCardImages/appointments.png"
                                       ></a>
                            </div>
        ...
        <%--  <section class="boxmenu">
                            <div class="box">
                                <a href="AdminRegistration.aspx?new=1">
                                    <img  src="../PostCardImages/add_user.png"
                                       ></a>
                            </div>
                            <span>Add Users</span>
                        </section>--%>
        <section class="boxmenu">
                            <div class="box">
                                <a href="features.aspx">
                                    <img  src="../PostCardImages/Features-icon.png"
                                       ></a>
                            </div>
        ...
        <section class="boxmenu">
                            <div class="box">
                                <a href="Banner.aspx">
                                    <img  src="../PostCardImages/banner_design.png"
                                       ></a>
                            </div>
