    ...
    public partial class AdminMaster : System.Web.UI.MasterPage
    {
        ...
        private void BindMenusList()  
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                //    }
                //}
                //StrMenu.Append("<li class='test' style='background:none;'><a  href='../StaticPages.aspx?PageID=39' title='Free Market Evaluation'> <img src='PostCardImages/4.png' /><div><span>F</span>ree Market Evaluation</div></a></li>");
                ////StrMenu.Append("<li class='test' style='background:none;'><a  href='Calculators.aspx' title='calculators'> <img src='PostCardImages/2.png' /><div><span>C</span>alculators</div></a></li>");
                //StrMenu.Append("<li class='test' style='background:none;'><a  href='#' title='Testimonial'> <img src='PostCardImages/2.png' /><div><span>T</span>estimonial</div></a></li>");
                //StrMenu.Append("<li class='test' style='background:none;'><a  href='#' title='Property looking for'> <img src='PostCardImages/3.png' /><div><span>P</span>roperty Looking for</div></a></li>");
                //StrMenu.Append("<li class='test' style='background:none;'><a  href='ContactUs.aspx' title='contact us'> <img src='PostCardImages/1.png' /><div><span>C</span>ontact us</div></a></li>");
